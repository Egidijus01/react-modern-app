...
const Hero = () =>  (
  ...
  <div className={`flex-q ${styles.flexStart} flex-col x1:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bf-discount-gradient rounded-[10px] mb-2'>
      ...
      <div className='flex flex-row justify-between utems-center w-full'>
