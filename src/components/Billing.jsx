    ...
    <section id='product' className={`${layout.sectionImgReverse}`}>
      ...
      <div className={`${layout.sectionInfo}`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          Doloremque qui esse rerum tempore reprehenderit repellat, nostrum aperiam quibusdam
          maiores iure hic dignissimos ut, aut accusantium optio. Rerum sequi impedit debitis.
        </p>
